...
const FeatureList = [
  {
    ...
    svg: (
      <svg viewBox="0 0 48 48" width="48" height="48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="24" cy="24" r="6" stroke="currentColor" strokeWidth="1.5" filter="url(#orbitGlow)"/>
        <ellipse cx="24" cy="24" rx="20" ry="9" stroke="currentColor" strokeWidth="1.5" transform="rotate(-15 24 24)" filter="url(#orbitGlow)"/>
        <circle cx="40" cy="17" r="3" fill="currentColor" opacity="0.7"/>
      </svg>
    ),
    description: (
      <>
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 48 48" width="48" height="48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M6 36 L14 20 L22 28 L30 12 L42 8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" filter="url(#chartGlow)"/>
        <circle cx="14" cy="20" r="2.5" fill="currentColor" opacity="0.5"/>
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 48 48" width="48" height="48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="6" y="6" width="36" height="36" rx="4" stroke="currentColor" strokeWidth="1.5" filter="url(#vizGlow)"/>
