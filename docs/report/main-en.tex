...
\newcommand{\eEmVersion}{v5.9.2 \quad September 2026}
...
\input{en/01-introduction}
\input{en/02-architecture}
\input{en/03-dynamics}
\input{en/04-orbit-design}
\input{en/05-transfer}
\input{en/06-control}
\input{en/07-interfaces}
\input{en/08-comparison}
\input{en/09-verification}
