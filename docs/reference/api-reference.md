...
- [E2M2E 技术文档](#e2m2e-技术文档)
  - [目录](#目录)
  - [1. Core Module (核心模块)](#1-core-module-核心模块)
    ...
    - [1.5 CoordinateTransformation \& ReferenceFrame](#15-coordinatetransformation-referenceframe)
      - [旋转系↔惯性系变换](#旋转系惯性系变换)
      - [核心方法](#核心方法_4)
  - [2. Algorithms Module (算法模块)](#2-algorithms-module-算法模块)
  ...
  - [3. Transfer Module (转移模块)](#3-transfer-module-转移模块)
    - [3.1 DROTransferSearch](#31-transfersearch-drotransfersearch)
      - [设计原理](#设计原理_5)
      - [搜索参数](#搜索参数直接在实例上设置)
      - [核心方法](#核心方法_8)
