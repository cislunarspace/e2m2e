...
- Rust integrator kernel: single-step RK (PD45 / PD78 / RK89), Adams multistep, Störmer–Cowell second-order integration; state transition matrix (STM) propagation; event detection (terminal / direction semantics).
