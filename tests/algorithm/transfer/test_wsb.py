...
from e2m2e.algorithm.transfer import WsbSearchParams, WsbTransferDetails, transfer_orbit
...
class TestWsbTransferDetails:
    """WSB 搜索结果的数据契约。"""

    def test_preserves_result_payload_and_status_triplet(self):
