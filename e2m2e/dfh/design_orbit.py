...
from ..algorithms.ephemeris_correction import (
    EphemerisCorrectionResult,
    correct_ephemeris_patch_points,
)
from ..algorithms.multiple_shooting import sample_patch_points_perilune_clustered
from ..core import CR3BP_Dynamics, Orbit
from ..core._spice_loader import get_spiceypy
...
from ..core.forces import ForceModel
...
class OrbitDesignResult:
    ...
    def write_ephemeris(self, path: str | Path) -> None:
        ...
        from ..io import write_ephemeris
