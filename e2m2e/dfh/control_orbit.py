...
from ..algorithms.station_keeping.monte_carlo import MonteCarloResult, run_monte_carlo
from ..core.coordinate.coordinate_system import CoordinateSystem
from ..core.coordinate.standard_axes import ICRSAxes
from ..core.coordinate.standard_origins import CelestialBodyOrigin
from ..core.ephemeris_system import EphemerisSystem
from ..core.spice import SPICEManager
from ..io.ephemeris import EphemerisTable, read_ephemeris
from ..io.force_mapping import dfh_perturbation_to_force_config
from ..io.inputs_dac import DEFAULT_DYB, DEFAULT_PERTURBATION
from ..io.maneuvers import ManeuverTable
from ..io.sk_statistic import SKStatistic
from .design_orbit import default_kernel_dir, load_design_kernels
...
class ControlOrbitResult:
    ...
    def write_outputs(self, out_dir: str | Path, mode: int = 1) -> list[Path]:
        ...
        from ..io.ephemeris import write_ephemeris
        from ..io.maneuvers import write_maneuvers
        from ..io.sk_statistic import write_sk_statistic
