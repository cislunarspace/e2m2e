//! build.rs — 解析包内 constants.toml，生成 Rust 物理常量模块。
//!
//! 单一来源：``e2m2e/data/constants/constants.toml``（随 Python 包分发）。本脚本在 cargo build 时把 TOML 中的
...
fn write_header(out: &mut String) {
    out.push_str(
        "// Auto-generated by build.rs -- do not edit manually.\n\
         // Single source of truth: e2m2e/data/constants/constants.toml.\n\n",
    );
}
...
fn main() {
    ...
    let constants_toml = manifest_dir
        ...
        .map(|p| p.join("e2m2e/data/constants/constants.toml"))
